...
public class alterarPaciente extends JFrame {
	...
	public alterarPaciente() {
		...
		JLabel lblNewLabel = new JLabel("Alterar Paciente");
		...
		lblNewLabel_1.setIcon(new ImageIcon(alterarPaciente.class.getResource("/images/edit.png")));
		...
		JButton btnNewButton_1_3_2_2 = new JButton("Alterar");
			...
			public void actionPerformed(ActionEvent e) {          	
				try 
				{
					...
					if(rdmasculino.isSelected()){
						paciente.setSexo(rdmasculino.getText());
					}
					else
						paciente.setSexo(rdfeminino.getText());
					
					pacienteDao.Update(paciente, (String)cbpacientes.getSelectedItem());
