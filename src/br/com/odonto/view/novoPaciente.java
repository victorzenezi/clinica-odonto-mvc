...
public class novoPaciente extends JFrame {
	...
	public novoPaciente() {
		...
		JLabel lblNewLabel = new JLabel("Novo Paciente");
		...
		lblNewLabel_1.setIcon(new ImageIcon(novoPaciente.class.getResource("/images/addpaciente.png")));
		...
		JButton btnNewButton_1_3_2_2 = new JButton("Cadastrar");
